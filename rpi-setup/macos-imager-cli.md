...
- installs and enables `bm-gateway-boot-receipt.service` for early reboot
  attribution
...
sudo systemctl is-enabled bm-gateway-lifecycle.service bm-gateway-boot-receipt.service bm-gateway-boot-notification.service
