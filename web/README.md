...
foundation stores the fixed delivery mode used by the USB OTG and Wi-Fi
watchdogs and reserved for later lifecycle producers: one `summary`,
`individual` emails, or `drop`. The selector
